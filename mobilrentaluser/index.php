            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">
						<center>
						<img src="assets/gambar/mobil1.jpg" class="img-responsive"/>
						<center>
						<br>
						...
						?>
                            <fieldset>
								<div class="form-group input-group">
                                            ...
                                            <input type="text" class="form-control" id="username" name="username" placeholder="Username" pattern=".{5,}" required="required">
                                </div>
                                <div class="form-group input-group">
                                            <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                            <input class="form-control" placeholder="Password" id="password" name="password" type="password" pattern=".{5,}" required="required">
                                </div>
                        ...
                        <form method="post" action="pendaftaran/index.php">
                            <fieldset>
