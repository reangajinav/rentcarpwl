            ...
            <div class="navbar navbar-inverse sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
							<center><img src="<?php echo $root; ?>/assets/gambar/mobil1.jpg" class="img-responsive" width="100%"><span class="masked"> </span></center>
						</li>
						<li>
						...
						<li>
                            <a href="<?php echo $root; ?>biayasewa/index.php"><i class="fa fa-file fa-fw"></i><span class="masked">Transaksi</span> </a>
                        </li>                                                 
                        <li>
                            <a href="<?php echo $root; ?>maps/index.php"><i class="fa fa-map fa-fw"></i><span class="masked"> Maps </span></a>
                        </li>
