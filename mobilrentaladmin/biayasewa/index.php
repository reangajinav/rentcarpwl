...
$sql    = "SELECT tb_transaksi.id_transaksi, tb_mobil.id_mobil, tb_mobil.type_mobil, tb_mobil.harga, tb_pelanggan.no_ktp, tb_pelanggan.nama_lengkap, tb_transaksi.tgl_sewa, tb_transaksi.tgl_selesaisewa, tb_transaksi.jumlah_harga, tb_transaksi.denda, tb_transaksi.status_pembayaran, tb_transaksi.status_pengembalian 
				FROM tb_transaksi 
				INNER JOIN tb_mobil on (tb_mobil.id_mobil=tb_transaksi.id_mobil)
				INNER JOIN tb_pelanggan on (tb_pelanggan.id_pelanggan=tb_transaksi.id_pelanggan) ORDER BY id_transaksi"; 
$result = mysql_query($sql);
}
//pagination
            ...
            <div class="row">
				<div class="col-md-12">
					...
					<div class="panel panel-success">
						...
						<button data-toggle="modal" data-target="#myModal" class="btn btn-primary btn-sm"><span class="fa fa-plus"></span> Tambah Data Biaya Transaksi</button></div>
                                ...
                                <table class="table table-striped table-bordered table-hover">
									...
									?>
										<tr>
											...
											<td>
												<center>
												<a class="btn btn-sm btn-info" href="laporan.php?id_transaksi=<?php echo $data['id_transaksi'] ?>" target="_blank" title="Print Data" ><span class="fa fa-print"></span></a>
