...
$sql 		= "SELECT tb_mobil.id_mobil, tb_mobil.foto_mobil, tb_mobil.type_mobil, tb_mobil.merk, tb_mobil.no_polisi, tb_mobil.warna, tb_mobil.harga, tb_mobil.status from tb_mobil WHERE type_mobil LIKE '%$keyword%' ORDER BY id_mobil asc";
			
$result = mysql_query($sql);
}else{
	//  jika tidak ada pencarian pakai ini
$reload = "index.php?pagination=true";
$sql    = "SELECT tb_mobil.id_mobil, tb_mobil.foto_mobil, tb_mobil.type_mobil, tb_mobil.merk, tb_mobil.no_polisi, tb_mobil.warna, tb_mobil.harga, tb_mobil.status from tb_mobil ORDER BY id_mobil asc"; 
$result = mysql_query($sql);
}
//pagination
            ...
            <div class="row">
				<div class="col-md-12">
					...
					<div class="panel panel-success">
						...
						<center></h3>PILIHAN MOBIL<center><h3>
						</div>
